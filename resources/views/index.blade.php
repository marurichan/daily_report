          ...
          <table class="search-table">
            ...
            <tbody class="search-tbody">
              <tr>
                ...
                <td class="search-td">
                  {{ Form::select('sex', [
                                    ...
                                    '男' => '男性',
                                    '女' => '女性'
                                  ], $requiredColumn['sex'],['class' => 'form-control', 'required' => 'required'])
                  }}
              ...
              <tr>
                ...
                <td class="search-td">
                  {{ Form::select('store_id', [
                                    ...
                                    '2' => '渋谷店',
                                    '3' => '池袋店'
                                  ], $requiredColumn['store_id'], ['class' => 'form-control', 'required' => 'required'])
                  }}
              ...
              <tr>
                ...
                <td class="search-td">
                  {!! Form::input('tel', 'tel', $requiredColumn['tel'], ['class' => 'form-control', 'placeholder'=>'ex) 08012345678 半角', 'pattern'=>'[0-9]{11}', 'required' => 'required']) !!}
              ...
              <tr>
                ...
                <td class="search-td">
                  {!! Form::input('date', 'birthday', $requiredColumn['birthday'], ['class' => 'form-control', 'required' => 'required', 'max' => '9999-12-31']) !!}
              ...
              <tr>
                ...
                <td class="search-td">
                  {!! Form::input('date', 'hire_date', $requiredColumn['hire_date'], ['class' => 'form-control', 'required' => 'required', 'min' => '2015-05-15', 'max' => '9999-12-31']) !!}
